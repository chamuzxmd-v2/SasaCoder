...
async function startBot() {
    ...
    sock.ev.on('connection.update', (update) => {
        ...
        if (connection === 'open') console.log('✅ SASACODER AI IS ONLINE!');
        if (connection === 'close') {
    ...
    sock.ev.on('messages.upsert', async (m) => {
        ...
        if (orderStates[sender]?.step === 'WAITING_FOR_ADDRESS') {
            ...
            const javaGoatOrder = {
                ...
                userEmail: "whatsapp@sasacoder.com",
        ...
        // --- DYNAMIC MENU FEATURE ---
            ...
            let menuMessage = "🐍 *SASACODER LIVE MENU* 🐍\n\n";
        ...
        // --- GREETINGS ---
            ...
            await sock.sendMessage(sender, { text: "👋 *Welcome to SasaCoder!* \n\nI am your AI Assistant. Type *menu* to see our Hacking Tools, or type *tool [dish]* to buy instantly!" });
        }
        else if (text.includes("contact") || text.includes("call")) {
            await sock.sendMessage(sender, { text: "📞 *Contact SasaCoder:* \n\n- *Email:* zzchamuz@gmail.com" });
        }
        else {
            await sock.sendMessage(sender, { text: "🤔 I didn't quite catch that.\n\nType *menu* to see our tool list, or *order [tool]* to place an order!" });
        }
    });
}
