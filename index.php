...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($input['email']) && isset($input['otp'])) {
        ...
        $subject = "Your SasaCoder Verification Code";
            ...
            <div class="auth-content">
                <div class="auth-card">
                    <div class="auth-header">
                        ...
                        <h1>Welcome Back</h1>
                        <p>Sign in to continue to SasaCoder</p>
                    </div>
             ...
             <div class="auth-content">
                <div class="auth-card">
                    <div class="auth-header">
                        ...
                        <p>Join the SasaCoder community</p>
                    </div>
        ...
        <div id="appContainer" class="page">
            <header class="app-header">
                <div class="header-top">
                    <h1><i class="fas fa-leaf" style="margin-right:10px;"></i> SasaCoder</h1>
